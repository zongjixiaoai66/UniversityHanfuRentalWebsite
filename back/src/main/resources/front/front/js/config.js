...
var centerMenu = [
    ...
    ,{
        name: '汉服收藏',
        url: '../hanfuCollection/list.html'
    }
    ,{
        name: '汉服租赁',
        url: '../hanfuOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '汉服信息',
        url: './pages/hanfu/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/gaoxiaohanfuzulinwangzhan/admin/dist/index.html#/login";
