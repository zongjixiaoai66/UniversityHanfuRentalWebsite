...
public class HanfuCommentbackView extends HanfuCommentbackEntity implements Serializable {
	...
	public HanfuCommentbackView() {

	}

	public HanfuCommentbackView(HanfuCommentbackEntity hanfuCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, hanfuCommentbackEntity);
