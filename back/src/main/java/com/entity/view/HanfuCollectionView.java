...
public class HanfuCollectionView extends HanfuCollectionEntity implements Serializable {
	...
	*/
	...
	private String hanfuCollectionValue;
	...
	public HanfuCollectionView() {

	}

	public HanfuCollectionView(HanfuCollectionEntity hanfuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, hanfuCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getHanfuCollectionValue() {
		return hanfuCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setHanfuCollectionValue(String hanfuCollectionValue) {
		this.hanfuCollectionValue = hanfuCollectionValue;
	}
	...
	public String toString() {
		return "HanfuCollectionView{" +
			", hanfuCollectionValue=" + hanfuCollectionValue +
			", hanfuName=" + hanfuName +
